...
def load_station_level_config(config_path: str | Path) -> StationLevelForecastConfig:
    ...
    return StationLevelForecastConfig(
        ...
        frequency=str(input_cfg.get("frequency", "daily")),
        ...
        mase_season_length=int(backtest_cfg.get("mase_season_length", default_mase_season_length(input_cfg.get("frequency", "daily")))),
